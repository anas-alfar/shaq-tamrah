		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Translation Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/translation', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="translation">Export 
							</button>
							<button class="btn btnImport" id="btnImport">Import
							</button>
							
							<!--<button class="btn btn-primary" id="btnBulkSave">
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									<th></th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Label" />
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Translation" >
									</th>
									<th class="hasinput">
