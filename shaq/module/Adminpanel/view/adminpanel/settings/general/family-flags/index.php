...
<script type="text/javascript">
		...
		function savefrmFormData()  {
			...
			//Validate  duplicate
			var isDuplicate = fn_validate_duplicate($("#name_<?php echo $this->global_locale_id; ?>").val(), 'beneficiary_profile_family_flags_locale', "name", "<?php echo $this->url('adminpanel/family-flags', array('action'=>'validateduplicate'));?>",iActiveID);
			if (isDuplicate) {
