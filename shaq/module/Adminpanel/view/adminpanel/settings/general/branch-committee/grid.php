		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Organization Branch Commitee Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/branch-committee', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="organization-branch-commitee">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Agenda" >
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Annual Plan" >
									</th>
									<th class="hasinput">
					            ...
					            <tr>
				                    ...
				                    <th>Agenda</th>
				                    <th data-hide="phone">Annual Plan</th>
