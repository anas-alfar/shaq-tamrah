		...
		<div class="col-sm-12 col-md-12 col-lg-12">
		     <div class="jarviswidget infocolor" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">  
				<header>
					...
					<h2>Beneficiary Relation Info </h2>
											...
											<div class="form-group">
												...
												<label class="customwidth">
													...
													<span class="onoffswitch">															
														<input name="allow_recurrence" class="onoffswitch-checkbox" id="allow_recurrence" type="checkbox">
														<label class="onoffswitch-label" for="allow_recurrence">
