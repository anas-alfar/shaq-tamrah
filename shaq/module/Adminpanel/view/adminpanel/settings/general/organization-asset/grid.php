		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Organization Asset Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/organization-asset', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="organization-asset">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Tax Value" />
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Tax Type" />
									</th>	
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Currency	" >
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Currency Exchange Rate" />
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Organization Branch" />
									</th>
									<th class="hasinput">
											<select id="statusfilter" name="statusfilter"class="searchdrop">
					            ...
					            <tr>
									<th>Id</th>
				                    <th data-class="expand">Asset Name</th>
				                    <th>Asset Type</th>
				                    <th data-hide="phone">Asset Unit</th>
				                    <th data-hide="phone,tablet">Cost</th>
				                    <th data-hide="phone,tablet">Tax Value</th>
									<th data-hide="phone,tablet">Tax Type</th>
									<th data-hide="phone,tablet">Currency</th>
				                    <th data-hide="phone,tablet">Currency Exchange Rate</th>
