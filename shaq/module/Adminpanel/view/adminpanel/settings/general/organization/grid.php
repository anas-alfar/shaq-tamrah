				...
				<header>
					...
					<h2>Organizations Listing</h2>
						...
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/organization', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="organization">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Organization Type" />
									</th>
									<th class="hasinput">
