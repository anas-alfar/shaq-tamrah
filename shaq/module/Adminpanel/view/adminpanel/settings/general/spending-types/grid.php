				...
				<header>
					...
					<h2>Spending Types Listing</h2>
						...
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/spending-types', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="spending-types">Export 
							</button>
