		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Post Types Listing</h2>
							
						<div class="widget-toolbar">
							<button class="btn btnExport" id="btnReorder" >Reorder 
							</button>
							<a href="<?php echo $this->url('adminpanel/post-types', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="post-types">Export 
							</button>
