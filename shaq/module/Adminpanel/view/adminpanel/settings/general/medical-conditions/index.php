...
<script type="text/javascript">
		...
		function savefrmFormData()  {
			...
			//Validate  duplicate
			var isDuplicate = fn_validate_duplicate($("#name_<?php echo $this->global_locale_id; ?>").val(), 'medical_condition_locale', "name", "<?php echo $this->url('adminpanel/medical-conditions', array('action'=>'validateduplicate'));?>",iActiveID);
			if (isDuplicate) {
