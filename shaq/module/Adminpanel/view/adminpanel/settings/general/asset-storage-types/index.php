...
<script type="text/javascript">
		...
		function savefrmFormData()  {
			...
			//Validate  duplicate
			var isDuplicate = fn_validate_duplicate($("#name_<?php echo $this->global_locale_id; ?>").val(), 'asset_storage_type_locale', "name", "<?php echo $this->url('adminpanel/asset-storage-types', array('action'=>'validateduplicate'));?>",iActiveID);
			if (isDuplicate) {
