				...
				<header>
					...
					<h2>Cities Listing</h2>
						...
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/cities', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="cities">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Population Count" >
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Houses Count" >
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Distance To Capital" >
									</th>
					            ...
					            <tr>
				                    ...
				                    <th>Country</th>
									<th data-hide="phone,tablet">Population Count</th>
									<th data-hide="phone,tablet">Houses Count</th>
									<th data-hide="phone,tablet">Distance To Capital</th>
