...
<script type="text/javascript">
		...
		function savefrmFormData()  {
			...
			var isDuplicate = fn_validate_duplicate_multiple('view_beneficiary_profile',"<?php echo $this->url('adminpanel/beneficiary-profile', array('action'=>'validateduplicate'));?>",iActiveID,objFormData);
			if (isDuplicate) {
				mySmallAlert('Duplicate Error...!', 'Duplicate Found.Profile Name for Selected Country is Already exists !', 0);
				return false;
			}
