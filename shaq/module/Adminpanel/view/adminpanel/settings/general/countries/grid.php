				...
				<header>
					...
					<h2>Countries Listing</h2>
						...
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/countries', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="countries">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Iso Code 2" >
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Iso Code 3" >
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Default Currency" >
									</th>
					            ...
					            <tr>
				                    ...
				                    <th>Iso Code 2</th>
									<th data-hide="phone,tablet">Iso Code 3</th>
									<th data-hide="phone,tablet">Default Currency</th>
