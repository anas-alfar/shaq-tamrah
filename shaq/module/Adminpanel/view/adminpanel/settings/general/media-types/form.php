							...
							<div class="tab-pane active panel panel-hovered panel-stacked mb30">
								<div id="tabs-<?php echo $this->global_locale_id; ?>">
									...
									<div class="row">								
										...
										<section class="col-md-6">
											<div class="form-group">
												<label class="control-label">Media Category<span>*</span></label>
													<select class="select2" id="media_category_id" name="media_category_id" type="select">														
														<option value="0">Select Media Category</option>
													</select> 
											</div>
											<div class="form-group">
												<label>&nbsp;</label>
