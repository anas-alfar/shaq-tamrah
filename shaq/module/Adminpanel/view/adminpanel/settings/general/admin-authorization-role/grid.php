		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Admin Authorization Roles Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/admin-authorization-role', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="admin-authorization-role">Export 
							</button>
