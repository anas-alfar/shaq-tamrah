		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Currency Exchange Rate Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/currency-exchange-rate', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="currency-exchange-rate">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									<th></th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="From Currency" />
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="To Currency" />
									</th>
									<th class="hasinput">
					            ...
					            <tr>
									<th>Id</th>
				                    <th data-class="expand">From Currency</th>
				                    <th>To Currency</th>
