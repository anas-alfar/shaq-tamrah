				...
				<header>
					...
					<h2>Payment Methods Listing</h2>
						...
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/payment-method', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="payment-method">Export 
							</button>
