		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Message Templates Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/message-templates', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="message-templates">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Message For" >
									</th>
									<th class="hasinput">
					            ...
					            <tr>
									<th>Id</th>
				                    <th data-class="expand">From Name</th>
				                    <th>To Name</th>
									...
									<th data-hide="phone,tablet">Message For</th>
									<th data-hide="phone,tablet">Message Type</th>
