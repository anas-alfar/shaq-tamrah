...
<script type="text/javascript">
		...
		function savefrmFormData()  {
			...
			*/
			...
			//Validate  duplicate
			var isDuplicate = fn_validate_duplicate($("#config_key").val(), 'configuration', "config_key", "<?php echo $this->url('adminpanel/configurations', array('action'=>'validateduplicate'));?>",iActiveID);
			if (isDuplicate) {
			...
			hideShowLoader(true);
			var objMyPost = AJAX_Post("<?php echo $this->url('adminpanel/configurations', array('action'=>'save'));?>", objFormData);
			if (objMyPost.ERR_NO === 0) {
				if (objMyPost.DATA.DBStatus === 'OK') {
					strActionMode = "EDIT";
					hideShowLoader(false);							
					fullscreenModeChange('btnSave');
					mySmallAlert('Save Record', 'Configuration Entry Saved successfully', 1);
		...
		fnBulkSave("<?php echo $this->url('adminpanel/configurations', array('action'=>'bulksave'));?>");
		fnImport("<?php echo $this->url('adminpanel/configurations', array('action'=>'importcsv'));?>");
		fnExport("<?php echo $this->url('adminpanel/configurations', array('action'=>'exportcsv'));?>");
		fnEdit("<?php echo $this->url('adminpanel/configurations', array('action'=>'getrec'));?>");
		fnView("<?php echo $this->url('adminpanel/configurations', array('action'=>'getrec'));?>");
		fnDelete("<?php echo $this->url('adminpanel/configurations', array('action'=>'delete'));?>"); 
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
              ...
              <h4 class="modal-title" id="ns_name_popup"><strong>Import Configuration</strong></h4>
         </div>
