		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Media Types Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/media-types', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="media-types">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Media Category" >
									</th>
					            ...
					            <tr>
				                    ...
				                    <th>Country</th>
									<th data-hide="phone,tablet">Media Category</th>
