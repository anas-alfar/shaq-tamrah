		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Post Categories Listing</h2>
							
						<div class="widget-toolbar">
							<button class="btn btnExport" id="btnReorder" >Reorder 
							</button>
							<a href="<?php echo $this->url('adminpanel/post-categories', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="post-category">Export 
							</button>
							...
							<button class="btn btnNew addEventBtn" id="btnNew">								<i class="fa fa-plus"></i> &nbsp;New
							</button>
						</div>
