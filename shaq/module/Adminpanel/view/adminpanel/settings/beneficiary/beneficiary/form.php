									...
									<div class="row">								
										<section class="col-md-6">
											<div class="form-group">
												...
												<textarea type="text" id="description_<?php echo $this->global_locale_id; ?>" name="description_<?php echo $this->global_locale_id; ?>" class="description form-control"  placeholder="Description"></textarea>
											</div>
										</section>
										<section class="col-md-6">
											<div class="form-group">
										...
										<div id="tabs-<?php echo $locale['id']; ?>">
											<div class="row">
												...
												<section class="col-md-6">
													<div class="form-group">
														<label class="control-label textarea textarea-resizable">Description</label>
														<textarea type="text" id="description_<?php echo $locale['id']; ?>" name="description_<?php echo $locale['id']; ?>" class="description form-control"  placeholder="Description"></textarea>
													</div>
												</section>
											</div>
										</div>
