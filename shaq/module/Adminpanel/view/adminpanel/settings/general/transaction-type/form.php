											...
											<div class="row">
												  <section class="col-md-6">
													<div class="form-group">
														<label class="control-label">Transaction Type Name<span>*</span></label>
														<input type="text" class="form-control" name="transaction_type_name" id="transaction_type_name"/>
													</div>
												 </section>
												 <section class="col-md-6">
													<div class="form-group">
