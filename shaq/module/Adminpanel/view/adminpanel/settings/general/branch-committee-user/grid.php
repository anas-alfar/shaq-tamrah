		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Organization Committee User Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/branch-committee-user', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="branch-committee-user">Export 
							</button>
						...
						<table id="tblMasterList" class="display projects-table table table-striped table-bordered table-hover" cellspacing="0" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Organization User Position" />
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Organization Branch " />
									</th>
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Organization Branch Committee" />
									</th>
								</tr>
					            <tr>
									<th>Id</th>
									<th></th>
				                    <th data-class="expand">Organization User Position</th>
				                    <th data-hide="phone,tablet">Organization Branch</th>
				                    <th data-hide="phone,tablet">Organization Branch Committee</th>
