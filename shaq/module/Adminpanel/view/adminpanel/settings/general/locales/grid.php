				...
				<header>
					...
					<h2>Locales Listing</h2>
						...
						<div class="widget-toolbar">
							...
							<button class="btn btnExport" id="btnExport" data-filename="locale">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Filter Locale Title" />
									</th>
									<th class="hasinput">
					            ...
					            <tr>
									<th>Id</th>
				                    <th data-class="expand">Locale</th>
				                    <th>Name</th>
