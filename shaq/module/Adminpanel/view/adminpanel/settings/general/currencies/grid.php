				...
				<header>
					...
					<h2>Currencies Listing</h2>
						...
						<div class="widget-toolbar">
							...
							<a href="<?php echo $this->url('adminpanel/currencies', array('action'=>'downloadtemplate'));?>" target="_blank">
							<button class="btn btnDownload" id="btnDownloadTemplate">Download Template
							</button>
							</a>
							<button class="btn btnExport" id="btnExport" data-filename="currencies">Export 
							</button>
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
								<tr>
									...
									<th class="hasinput">
										<input type="text" class="form-control" placeholder="Currency Title" />
									</th>
