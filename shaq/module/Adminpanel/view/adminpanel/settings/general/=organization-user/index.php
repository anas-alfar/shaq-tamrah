...
<script type="text/javascript">
		...
		function fetch_grid_data(objFormData)
		{
			...
			$.ajax({
			  type: "POST",
			  url: "<?php echo $this->url('adminpanel/organization-user', array('action'=>'list'));?>",
			  data: objFormData,
			  dataType: "json",
		...
		function savefrmFormData()  {
			...
			//Validate  duplicate
			var isDuplicate = fn_validate_duplicate($("#from_name_<?php echo $this->global_locale_id; ?>").val(), 'message_template_locale', "from_name", "<?php echo $this->url('adminpanel/organization-user', array('action'=>'validateduplicate'));?>",iActiveID);
			if (isDuplicate) {
			...
			hideShowLoader(true);
			var objMyPost = AJAX_Post("<?php echo $this->url('adminpanel/organization-user', array('action'=>'save'));?>", objFormData);
		...
		fnBulkSave("<?php echo $this->url('adminpanel/organization-user', array('action'=>'bulksave'));?>");
		fnExport("<?php echo $this->url('adminpanel/organization-user', array('action'=>'exportcsv'));?>");
		fnImport("<?php echo $this->url('adminpanel/organization-user', array('action'=>'importcsv'));?>");
		fnEdit("<?php echo $this->url('adminpanel/organization-user', array('action'=>'getrec'));?>");
		fnView("<?php echo $this->url('adminpanel/organization-user', array('action'=>'getrec'));?>");
		fnDelete("<?php echo $this->url('adminpanel/organization-user', array('action'=>'delete'));?>"); 
		 ...
		 <form action="" class="smart-form" enctype="multipart/form-data" name="importcsvform" id="importcsvform">
			<fieldset>
				<section>
					...
					<div class="note note-error">Please <a href="<?php echo $this->url('adminpanel/organization-user', array('action'=>'downloadtemplate'));?>" target="_blank">download template </a>first (if you don't have download yet!)
					</div>
				</section>
			</fieldset>			
		 </form>
