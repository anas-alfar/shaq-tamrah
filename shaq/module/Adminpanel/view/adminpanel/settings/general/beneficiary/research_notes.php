<div class="tab-pane" id="research_notes">
<div class="tabs-main-heading">	
				...
				<div class="row">
					<section class="col-md-4">
						<div class="form-group">
							...
							<textarea type="text" class="form-control" name="researcher_recommendations_<?php echo $this->global_locale_id; ?>" id="researcher_recommendations_<?php echo $this->global_locale_id; ?>"></textarea>
						</div>
					</section>
					<section class="col-md-4">	
						<div class="form-group">
							<label class="control-label">Researcher Name<span>*</span></label>
							<textarea type="text" class="form-control" name="researcher_name_<?php echo $this->global_locale_id; ?>" id="researcher_name_<?php echo $this->global_locale_id; ?>"></textarea>
						</div>
					</section>
					<section class="col-md-4">
						<div class="form-group">
							<label class="control-label">Committee Recommendations<span>*</span></label>
							<textarea type="text" class="form-control" name="committee_recommendations_<?php echo $this->global_locale_id; ?>" id="committee_recommendations_<?php echo $this->global_locale_id; ?>"></textarea>
						</div>
					</section>
				</div>	
				<div class="row">
					<section class="col-md-4">	
						<div class="form-group">
							...
							<textarea type="text" class="form-control" name="committee_member_name_<?php echo $this->global_locale_id; ?>" id="committee_member_name_<?php echo $this->global_locale_id; ?>"></textarea>
						</div>
					</section>
					<section class="col-md-4">
						<div class="form-group">
							<label class="control-label">Committee Manager Name<span>*</span></label>
							<textarea type="text" class="form-control" name="committee_manager_name_<?php echo $this->global_locale_id; ?>" id="committee_manager_name_<?php echo $this->global_locale_id; ?>"></textarea>
						</div>
					</section>
					<section class="col-md-4">
						<div class="form-group">
			...
			<?php 
				foreach($this->activeLocalesArray as $locale)
				{
					...
					<section class="col-md-4">
						<div class="form-group">
							<label class="control-label">Researcher Recommendations<span>*</span></label>
							<textarea type="text" class="form-control" name="researcher_recommendations_<?php echo $locale['id']; ?>" id="researcher_recommendations_<?php echo $locale['id']; ?>"></textarea>
						</div>
					</section>
					<section class="col-md-4">	
						<div class="form-group">
							<label class="control-label">Researcher Name<span>*</span></label>
							<textarea type="text" class="form-control" name="researcher_name_<?php echo $locale['id']; ?>" id="researcher_name_<?php echo $locale['id']; ?>"></textarea>
						</div>
					</section>
					<section class="col-md-4">
						<div class="form-group">
							<label class="control-label">Committee Recommendations<span>*</span></label>
							<textarea type="text" class="form-control" name="committee_recommendations_<?php echo $locale['id']; ?>" id="committee_recommendations_<?php echo $locale['id']; ?>"></textarea>
						</div>
					</section>
				</div>	
				<div class="row">
					<section class="col-md-4">	
						<div class="form-group">
							<label class="control-label">Committee Member Name<span>*</span></label>
							<textarea type="text" class="form-control" name="committee_member_name_<?php echo $locale['id']; ?>" id="committee_member_name_<?php echo $locale['id']; ?>"></textarea>
						</div>
						<div class="form-group">
							<label class="control-label">Committee Manager Name<span>*</span></label>
							<textarea type="text" class="form-control" name="committee_manager_name_<?php echo $locale['id']; ?>" id="committee_manager_name_<?php echo $locale['id']; ?>"></textarea>
						</div>
					</section>
					<section class="col-md-4">
						<div class="form-group">
 ...
 <script language="javascript">
	function savefrmResearcherNotesData()
	{
		...
		var objMyPost = AJAX_Post("<?php echo $this->url('adminpanel/beneficiary', array('action'=>'saveResearcherNotes'));?>", objFormData);
		if (objMyPost.ERR_NO === 0) {
			if (objMyPost.DATA.DBStatus === 'OK') {
				hideShowLoaderActive(false);		
				callNextTab('research_notes');
			}
		}
		else {
			hideShowLoaderActive(false);
