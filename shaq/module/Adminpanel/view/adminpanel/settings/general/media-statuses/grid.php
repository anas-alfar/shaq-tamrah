		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<header>
					...
					<h2>Media Statuses Listing</h2>
							
						<div class="widget-toolbar">
							<a href="<?php echo $this->url('adminpanel/media-statuses', array('action'=>'downloadtemplate'));?>" target="_blank">
						...
						<table id="tblMasterList" class="table table-striped table-bordered" width="100%">	
					        <thead>
					            ...
					            <tr>
									...
									<th data-hide="phone,tablet" class="action">Description</th>
