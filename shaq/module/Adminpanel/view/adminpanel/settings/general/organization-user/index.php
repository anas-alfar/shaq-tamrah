...
<script type="text/javascript">
		...
		function savefrmFormData()  {
			...
			//Validate  duplicate
			var isDuplicate = fn_validate_duplicate($("#ssn").val(), 'organization_user', "ssn", "<?php echo $this->url('adminpanel/organization-user', array('action'=>'validateduplicate'));?>",iActiveID);
			if (isDuplicate) {
