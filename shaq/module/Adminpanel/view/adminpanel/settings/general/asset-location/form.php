										...
										<section class="col-md-12">
											<div class="form-group">
     										   <label class="control-label">Geo Location<span>*</span></label>
													<input id="geo_location" class="controls form-control" type="text" name="geo_location" placeholder="Location">
			 										<div id="map"></div>
													<div id="IframeId" class="mt30"></div>
											</div>
										</section>	
									  <input type="hidden" id="latitude" name="latitude" class="form-control " value="-33.8688"  >
									  <input type="hidden" id="longitude" name="longitude" class="form-control "  value="151.2195" >
								   </div>
