...
<script type="text/javascript">
		...
		function savefrmFormData()  {
			...
			//Validate  duplicate
			var isDuplicate = fn_validate_duplicate($("#name_<?php echo $this->global_locale_id; ?>").val(), 'death_reason_locale', "name", "<?php echo $this->url('adminpanel/death-reasons', array('action'=>'validateduplicate'));?>",iActiveID);
			if (isDuplicate) {
